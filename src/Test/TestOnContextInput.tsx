...
import { OutlinedInput, Popover, Typography, TextField, Button } from '@mui/material';
...
function CustomOutlinedInput() {
    ...
    const handleSave = () => {
        const newValue = value.substring(0, editStart) + editValue + value.substring(editEnd);
        setValue(newValue);
        handleClose();
    };
    ...
    return (
        <>
            ...
            >
                <Typography style={{ padding: '10px' }}>Chỉnh sửa đoạn văn bản:</Typography>
                <TextField
                    value={editValue}
